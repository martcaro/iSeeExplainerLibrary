    ...
    def get(self,id=None):
        ...
        if id is not None:
            ...
            if model_info["attributes"]["features"][target_name]["data_type"]=="categorical":
                ...
                base_dict["params"]["sigma"]["description"]="Bandwith of the low pass filter. The higher the sigma, the more frequencies are kept. Sigma should be positive and less than image size. Defaults to square root of the smallest dimension of the image."
                base_dict["params"]["sigma"]["default"]=int(math.sqrt(min(model_info["attributes"]["features"]["image"]["shape"][0],model_info["attributes"]["features"]["image"]["shape"][1])))

...
class GuidedBackpropExp(Resource):
    ...
    def get(self,id=None):
        base_dict={
        "_method_description": "Guided-backprop operation is similar to Saliency: it consists in backpropagating the output score with respect to the input, however, at each non-linearity (the ReLUs), only the positive gradient of positive activations are backpropagated. We can see this as a filter on the backprop."

...
class DeconvNetExp(Resource):
    ...
    def get(self,id=None):
        base_dict={
        "_method_description": "The DeconvNet method which modifies the classic Saliency procedure on ReLU's non linearities, allowing only the positive gradients (even from negative inputs) to pass through."

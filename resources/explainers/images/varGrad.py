...
class VarGradExp(Resource):
    ...
    def post(self):
        try:
            ...
            try:
                ...
                pass
            try:
                explainer=VarGrad(mlp,nb_samples=nb_samples, noise=noise)
    ...
    def get(self,id=None):
        base_dict={
        "_method_description": "Similar to SmoothGrad, VarGrad is a gradient-based explanation method, which, as the name suggests, return the variance of the gradient at several points corresponding to small perturbations around the point of interest. The smoothing effect induced by the average help reducing the visual noise, and hence improve the explanations."

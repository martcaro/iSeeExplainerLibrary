...
class SquareGradExp(Resource):
    ...
    def post(self):
        try:
            ...
            try:
                ...
                pass
            try:
                explainer=SquareGrad(mlp,nb_samples=nb_samples, noise=noise)
    ...
    def get(self,id=None):
        base_dict={
        "_method_description": "Similar to SmoothGrad, Square-Grad is a gradient-based explanation method, which, as the name suggests, averages the square of the gradient at several points corresponding to small perturbations around the point of interest. The smoothing effect induced by the average help reducing the visual noise, and hence improve the explanations."
